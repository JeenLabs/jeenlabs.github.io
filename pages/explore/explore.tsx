...
const Explore = () => {
  return (
    <section className="explore-container1">
      <div id="Explore" className="explore-hero-section">
        <div className="explore-hero-container">
          <div className="explore-hero-quote-container">
            <span className="explore-hero-quote-text">
              Discover Our Solutions
            </span>
            <div className="explore-container2"></div>
          </div>
          <div className="explore-hero-content-container">
            <span className="explore-hero-content-text">
              <span className="explore-text1">Empower</span>
              <span>
                {" "}
                your business with cutting-edge digital solutions tailored to
                your needs.
              </span>
              <br></br>
              <span>
              ...
              <span className="explore-text5">JEENL</span>
              <span className="explore-text6">A</span>
              <span className="explore-text7">BS</span>
              <span>
                , we specialize in automation, website development, and software
                development, helping businesses streamline operations, enhance
                their online presence, and achieve scalable growth.
              </span>
            </span>
          </div>
          <div className="explore-container3"></div>
          <div className="explore-container4">
            <div className="explore-container5">
              <button type="button" className="explore-button">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  className="explore-icon1"
                >
                  <g
                    fill="none"
                    stroke="currentColor"
