...
export default function ProjectsPage() {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      category: "Web Development",
      description:
        "Mobile-friendly web application for restaurant ordering with real-time order tracking and payment processing.",
      imageUrl: "/placeholder.svg?height=400&width=600",
    },
    {
      ...
      category: "Software Development",
      description:
        "Comprehensive HR system with employee onboarding, time tracking, performance reviews, and payroll integration.",
      imageUrl: "/placeholder.svg?height=400&width=600",
    },
    {
      ...
      category: "Automation",
      description:
        "Automated data extraction tool that processes documents and forms, reducing manual data entry by 90%.",
      imageUrl: "/placeholder.svg?height=400&width=600",
    },
  ]
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative py-20 px-4 bg-black">
        <div className="container mx-auto text-center">
          ...
          >
            Our <span className="text-jeenlabs-red">Projects</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredItems.map((item, index) => (
              <PortfolioItem
                ...
                delay={0.1 * (index % 6)} // Limit delay to avoid too long delays
              />
            ))}
          </div>
        </div>
